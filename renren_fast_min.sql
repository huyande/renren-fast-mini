...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RenrenScheduler', 'huyande1645780302143', 1645781130136, 15000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RenrenScheduler', 'TASK_1', 'DEFAULT', 'TASK_1', 'DEFAULT', NULL, 1645781400000, -1, 5, 'WAITING', 'CRON', 1643111159000, 0, NULL, 2, );
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `schedule_job` VALUES (1, 'testTask', 'renren', '0 0/30 * * * ?', 0, '参数测试', '2022-01-25 19:42:28');
COMMIT;
...
CREATE TABLE `schedule_job_log` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `job_id` (`job_id`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8mb4 COMMENT='定时任务日志';
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COMMENT='角色与菜单对应关系';
...
INSERT INTO `sys_role_menu` VALUES (2, 1, 7);
INSERT INTO `sys_role_menu` VALUES (3, 1, 8);
...
INSERT INTO `sys_role_menu` VALUES (10, 1, -666666);
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user_token` VALUES (1, '093a521a7f601af90a9931f2d9633c6b', '2022-02-25 02:59:04', '2022-02-24 14:59:04');
INSERT INTO `sys_user_token` VALUES (2, '4c7c95893402743ebe87690d0bb1d110', '2022-01-26 08:37:43', '2022-01-25 20:37:43');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `tb_wxuser` VALUES (2, 'o5e4344weFj2xYYJCeQHieidizX0', 'https://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTKibpIaZuXjqic2S3tgClP4N7CUBbicLlWxk7rGibHJeIwDzeialicpX44MVxECTfXOHeyEHVxfUicBnnodA/132', 'Mark');
COMMIT;
